...
def calc_div_stats(div_df_input):
    ...
    stats['maximum_cut_pct'] = div_df['inc_pct'].min()
    stats['max_10y_cut_pct'] = div_df['inc_pct'][-10:-1].min()
...
def calc_ratio_history(price_df, fin_df, n_shares=None, ratio='pe', reported_currency='IDR', target_currency='IDR'):
